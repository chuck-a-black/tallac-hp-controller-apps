...
@References(value={
    @Reference(name="TestAppService", 
               referenceInterface=com.tallac.cb.api.TestAppService.class,
...
public class ServiceAssistant {
    ...
    /**
     * Hook for registering TestAppService implementation via declarative services.
     *
     * @param s newly advertised service to register
     * @param properties the properties associated with the service
     */
    protected void bindTestAppService(com.tallac.cb.api.TestAppService s, Map<String, Object> properties) {
        sl.register(com.tallac.cb.api.TestAppService.class, s, properties);
    }
     ...
     */
    protected void unbindTestAppService(com.tallac.cb.api.TestAppService s) {
        sl.unregister(com.tallac.cb.api.TestAppService.class, s);
    }
