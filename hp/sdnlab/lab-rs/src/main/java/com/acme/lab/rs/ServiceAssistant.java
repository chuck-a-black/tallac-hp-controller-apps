...
@References(value={
    @Reference(name="SdnLabService", 
               referenceInterface=com.acme.lab.api.SdnLabService.class,
...
public class ServiceAssistant {
    ...
    /**
     * Hook for registering SdnLabService implementation via declarative services.
     *
     * @param s newly advertised service to register
     * @param properties the properties associated with the service
     */
    protected void bindSdnLabService(com.acme.lab.api.SdnLabService s, Map<String, Object> properties) {
        sl.register(com.acme.lab.api.SdnLabService.class, s, properties);
    }
     ...
     */
    protected void unbindSdnLabService(com.acme.lab.api.SdnLabService s) {
        sl.unregister(com.acme.lab.api.SdnLabService.class, s);
    }
